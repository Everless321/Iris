...
echo "==> 启动节点 a/b1/b2"
IRIS_NODE_ID=b1 IRIS_DATA_ADDR=0.0.0.0:7445 ./target/debug/iris-node > /tmp/zf-b1.log 2>&1 &
IRIS_NODE_ID=b2 IRIS_DATA_ADDR=0.0.0.0:7446 ./target/debug/iris-node > /tmp/zf-b2.log 2>&1 &
IRIS_NODE_ID=a  IRIS_DATA_ADDR=0.0.0.0:7444 ./target/debug/iris-node > /tmp/zf-a.log 2>&1 &
sleep 4
